...
import CommonBulletin from '~/components/CommonBulletin.vue' // 导入 CommonBulletin
import CommonFooter from '~/components/CommonFooter.vue' // 导入 CommonFooter
import TabList from '~/components/TabList.vue'
import { reactive, ref, onMounted } from 'vue';
import { useRuntimeConfig } from '#imports'
import UForm from '@element-plus/u-form'
import UInput from '@element-plus/u-input'
import UButton from '@element-plus/u-button'
